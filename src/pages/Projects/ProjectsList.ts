...
const ProjectList = [
  {
    ...
    tech: ['Elixir', 'Golang', 'Kubernetes', 'Docker', 'PostgreSQL'],
    github: [
      {
        url: 'https://github.com/galaddirie/browsergrid',
      },
    ],
    demo: [],
  },
  {
    title: 'Silk - Declarative Webscraping',
    image: silkImg,
    description: [
      'Developed a declarative webscraping tool that allows users to scrape websites using a simple, declarative syntax.',
      'The tool is built using Python and the Scrapy framework, and allows users to scrape websites using a simple, declarative syntax.',
    ...
    tech: ['python', 'scrapy', 'selenium', 'playwright', 'puppeteer'],
    github: [
      {
  ...
  },
  {
    ...
    tech: ['python', 'django', 'redis', 'aws', 'postgresql', 'docker'],
    github: [
      {
  ...
  },
  {
    ...
    tech: ['node', 'react', 'aws', 'postgresql', 'graphql'],
    github: [
      {
  ...
  },
  {
    title: 'galad.ca',
    image: portfolioImg,
    description: ['You are here!', 'Created to showcase my personal projects.'],
